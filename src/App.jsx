...
const Web3WalletApp = () => {
  ...
  const createBuyContract = async () => {
    const provider = new BrowserProvider(window.ethereum);  // replaces Web3Provider
    const signer = await provider.getSigner();              // same method in v6
    const newContract = new Contract("0xB043aC00205FE7A32628879847027B0dF21da582", BUY_ABI, signer); // same constructor
  ...
  const buy = async (evt) => {
    ...
    try {
      ...
      const approveTx = await tokenContract.approve("0xB043aC00205FE7A32628879847027B0dF21da582", approveAmountWithDecimals);
      ...
      setSuccess(
        <div>
          <p>Transaction successful! Bought {amount} CDC Tokens.</p>
          <p className="mt-2">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-white">Buy CredPal Debt Capital Token</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                {loading ? 'Processing...' : 'Approve & Buy CDC'}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 max-w-2xl mx-auto bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
          ...
          <ul className="space-y-2 text-indigo-200 text-sm">
            ...
            <li>• Enter the amount of CDC tokens you want to buy</li>
            <li>• Click "Approve & Buy CDC" - this will handle both approval and purchase automatically</li>
